...
public class DataVerification {
	...
	private boolean checkTheFirstName(String arrForma) {
		return checkingWhetherThisLineIs(arrForma instanceof String, "Вы ввели не веный формат Имени, допустимы только буквы");
	}
	...
	private boolean checkTheGender(String arrForma) {
		return checkingWhetherThisLineIs(arrForma.equals("М") || arrForma.equals("м") || arrForma.equals("Ж") || arrForma.equals("ж"), "указан не верный формат допустимые симовыл: М м Ж ж ");
	}
}
